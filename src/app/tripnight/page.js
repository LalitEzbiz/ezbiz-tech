...
export default function TripNightProfile() {
  return (
          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="mt-2 text-gray-300">
                TripNight is an online travel marketplace offering curated travel packages and holiday deals from verified agents worldwide. It connects travelers with destination experts and travel advisors to ensure authentic, tech-powered travel experiences.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-gray-300">
                The goal was to create a platform where users could search holiday packages by destination, view hotel room availability, and book through a CRS Booking Engine. TripNight needed a dynamic search, pricing view, and trip selection workflow.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-gray-300">
                We designed a streamlined interface to explore destinations and packages. The backend allows real-time updates of room data, availability, and pricing. It also includes a booking engine connected to hotels and contact sections to boost conversions.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-gray-300">
                The platform has successfully helped users discover and book holiday packages, while enabling TripNight to attract travelers from across India with improved digital visibility.
              </p>
            </section>
          </div>
