...
export default function EurekaBookstoreProfile() {
  return (
          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="mt-2 text-gray-300">
                Eureka Bookstore, India’s first independent children’s bookstore, began in 2003 and focuses on helping parents and schools discover meaningful stories for kids. It is also behind Bookaroo, India’s first literature festival for children.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-gray-300">
                Eureka needed a web solution to allow parents, schools, and institutions to order children’s books online. The platform also had to handle bulk order processing, book categorization, and backend order management.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-gray-300">
                Ezbiz created a clean UI with categories for age groups, reading levels, and genres. The admin panel allows order and inventory management, while the frontend encourages parents and teachers to discover titles intuitively.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-gray-300">
                The updated website improved the browsing and buying experience and gave the bookstore a digital edge in school and library outreach.
              </p>
            </section>
          </div>
