...
export default function FNBBasketProfile() {
  return (
          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="mt-2 text-gray-300">
                FNB Basket is one of Germany’s leading Indian grocery e-commerce platforms, offering quality food staples, snacks, beverages, and personal care products at great prices. Their catalog helps Indian families abroad shop conveniently online.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-gray-300">
                The goal was to develop the platform from scratch with user-focused features like intuitive grocery categories, recommendations, product filtering, and simplified ordering. An admin panel was needed for product management and delivery tracking.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-gray-300">
                We designed an e-commerce UI with product grids, deals of the day, and order insights. The backend allowed the FNB Basket team to manage inventory, promote offers, and fulfill orders efficiently via a dynamic admin dashboard.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-gray-300">
                The website surpassed client expectations in Germany and helped increase order volumes and customer loyalty. Ongoing enhancements continue to drive sales and engagement.
              </p>
            </section>
          </div>
