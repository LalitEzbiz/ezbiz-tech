        ...
        <div className="relative z-10 p-6">
          ...
          {showModal && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
              <div
                className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 relative animate-fade-in-up text-gray-800"
                style={{
                  maxHeight: '60vh', // Reduced from 90vh to 70vh
                  overflowY: 'auto',
                }}
              >
                <button
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none text-gray-800"
                    ></textarea>
                  </div>
